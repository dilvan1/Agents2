...
public class LangEdif {
        ...
        try {
            ...
            try {
                for (int aux1 = 0; aux1 < vet1.size(); aux1++)
                    strList.add((String) vet1.get(aux1));
            } catch (RuntimeException re) {
    ...
    Object edif_instance(List list) throws LangException {
        ...
        try {
            ...
            try {
                cell = (Hashtable) currentLibrary.get((String) list.get(0));
                if (cell == null) {
    ...
    protected Object edif_qualify(List list) throws LangException {
        ...
        try {
            ...
            for (aux1 = 0; aux1 < list.size(); aux1++)
                newList.add((String) list.get(aux1));
    ...
    Object edif_scale(List list) throws LangException {
        ...
        newList.add("SCALE");
        try {
            newList.add((String) list.get(0));
            newList.add((Number) list.get(1));
            newList.add((Number) list.get(2));
        } catch (RuntimeException re) {
    ...
    protected Object edif_translate(List list) throws LangException {
        ...
        try {
            newList.add((Integer) list.get(0));
            newList.add((Integer) list.get(1));
        } catch (RuntimeException re) {
    ...
    protected Object evalInternal() throws IOException, LangException {
        ...
        while (!analex.word().equals(")")) {
            ...
            if (palavra.equals("(")) {
                ...
                if (analex.lexicClass().equals("INTEGER")) list.add(new Integer(analex.integer()));
                else {
                    if (palavra.length() == 0) throw new LangException("EOF not expected");
